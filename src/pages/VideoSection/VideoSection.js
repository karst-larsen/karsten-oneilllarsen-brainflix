...
class VideoSection extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get("https://restless-shadow-5418.fly.dev/videos")
      .then((response) => {
        this.setState({
  ...
  fetchMainVideo = (videoId) => {
    ...
    axios
      .get(`https://restless-shadow-5418.fly.dev/videos/${videoId}`)
      .then((response) => {
        this.setState(
          {
  ...
  render() {
    ...
    return (
      <>
        <div
          className={`header__upload-notification ${
            uploadSuccess === "uploadComplete"
              ? "header__upload-notification--success"
              : ""
          }`}
        >
